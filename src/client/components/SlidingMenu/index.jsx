...
import { Menu, List, SettingsBackupRestore, Settings, Help, Close } from '@material-ui/icons'
    ...
    <div>
      ...
      >
        <div className={classes.menuWrapper}>
          ...
          <MenuItemWrapper>
            <MenuItem to={PATHS.BACKUP_RESTORE} onClick={toggleDrawer(false)}>
